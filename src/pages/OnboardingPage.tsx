  ...
  const onboardingSteps = [
    {
      ...
      description:
        "Prepare-se para descobrir seus talentos, desenvolver novas habilidades e construir o futuro que você sempre sonhou.",
      icon: (
        <img
    ...
    },
    {
      ...
      description:
        "Aqui você vai descobrir seus pontos fortes, definir metas claras e criar um plano personalizado para alcançar seus objetivos profissionais.",
      icon: (
        <img
          src="https://i.imgur.com/TmfqRTD.gif"
          alt="Logo Tryla"
    ...
    {
      title: "Conecte-se com a uma grande comunidade",
      subtitle: "Juntos chegamos mais longe!",
      description:
        "Faça parte de uma comunidade inspiradora de jovens determinados a construir um futuro brilhante. Compartilhe experiências e cresça junto com outros.",
      icon: (
        <img
          src="https://i.imgur.com/TmfqRTD.gif"
          alt="Logo Tryla"
      ...
      <div className="max-w-lg mx-auto w-full">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/50 p-6 mb-6">
          <div className="flex justify-center mb-6">
            <div className="rounded-full"> {currentStepData.icon}</div>
          </div>
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-slate-900 mb-3">
              {currentStepData.title}
            </h1>
            <p className="text-lg font-semibold text-trilha-orange mb-4">
